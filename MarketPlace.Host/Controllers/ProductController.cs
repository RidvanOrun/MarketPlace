    ...
    public class ProductController : Controller
    {
        ...
        public async Task<ActionResult<Product>> Edit(Product product)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using var request = await httpClient.PutAsync($"http://localhost:51887/api/product", content);
        ...
        public async Task<IActionResult> Delete(Product product)
        {
            using (var httpClient = new HttpClient())
            {
                using var request = await httpClient.DeleteAsync($"http://localhost:51887/api/product");
            }
